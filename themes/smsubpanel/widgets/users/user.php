...
<div class="col-md-12 ml-auto mt-3"> <!-- https://getbootstrap.com/docs/4.0/layout/grid/#mix-and-match -->
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-chevron p-2 bg-body-tertiary rounded-3">
            ...
            <li class="breadcrumb-item"><a class="link-body-emphasis fw-semibold text-decoration-none text-<?=CONF_PANEL_COLOR?>" href="<?=url("/painel/agenda/ramais/ativados")?>"><i class="bi bi-person"></i> Usuários</a></li>
            <li class="breadcrumb-item fw-semibold active" aria-current="page"><i class="bi bi-person-add"></i> <?php if(!empty($contact->id)): echo "Editar Ramal ".$contact->ramal; else : echo "Novo Usuário"; endif;?></li>
        </ol>
    </nav>
</div>
...
<div class="row justify-content-center">
    <div class="col-xl-12">
        <?php if (!$user): ?>
            ...
            <div class="col-12">
                <form class="row gy-2 gx-3 align-items-center needs-validation" novalidate id="contact-register" action="<?=url("/painel/usuarios/usuario")?>" method="post" enctype="multipart/form-data">
        ...
        <?php else: ?>
            ...
            <div class="dash_content_app_box">
                <form class="app_form" action="<?= url("/painel/usuarios/usuario/{$user->id}"); ?>" method="post">
                    <!--ACTION SPOOFING-->
                    ...
                    <div class="app_form_footer">
                        ...
                        <a href="#" class="remove_link icon-warning"
                           data-post="<?= url("/painel/usuarios/usuario/{$user->id}"); ?>"
                           data-action="delete"
