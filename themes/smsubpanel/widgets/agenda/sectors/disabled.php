...
<div class="col-md-12 ml-auto mt-3"> <!-- https://getbootstrap.com/docs/4.0/layout/grid/#mix-and-match -->
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-chevron p-2 bg-body-tertiary rounded-3">
            ...
            <li class="breadcrumb-item fw-semibold active" aria-current="page"><i class="bi bi-list"></i> Setores Desativados <span class="badge bg-secondary rounded-pill"><?=$lixeira?></span></li>
        </ol>
    </nav>
</div>
            ...
            <div class="card-body">
                <div class="container-fluid">
                    ...
                    <div class="row justify-content-center mb-4">
                        <div class="col-md-12 ml-auto text-center">
                            <a data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-custom-class="custom-tooltip"
                               data-bs-title="Clique para listar ramais" class="btn btn-outline-danger btn-sm fw-semibold" href="<?=url("/painel/agenda/setores/ativados")?>"
                    ...
                    <div class="d-flex justify-content-center">
                        <div class="col-12">
                            <table id="sectorsDisabled" class="table table-sm table-bordered border-secondary table-striped" style="width:100%">
                                ...
                                ?>
                                    <tr>
                                        <?php if(!empty($list->sector_name) && $list->status == "actived"):
                                            echo '<td class="text-center">'.$list->sector_name;
                                        else:
                                            echo '<td class="text-center text-danger"><del>'.$list->sector_name.'<del>';
                                        endif;
                                        ?></td>
