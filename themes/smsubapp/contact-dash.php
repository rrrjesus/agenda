...
<div class="container-fluid">
    ...
    <div class="row justify-content-center mb-4">
        <div class="col-md-12 ml-auto text-center">
            ...
            <a data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-custom-class="custom-tooltip"
               data-bs-title="Clique para listar lixeira de contatos" class="btn btn-outline-secondary" href="<?=url("/dashboard/listar-lixeira-contatos")?>"
               role="button"><i class="bi bi-trash-fill me-2"></i>Lixo</a>
        </div>
    </div>
