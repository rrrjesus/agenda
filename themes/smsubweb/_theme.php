        ...
        <div class="row">
            ...
            <div class="col-lg-2 mb-3">
                ...
                <ul class="list-unstyled">
                    ...
                    <li class="mb-2"><a class="text-decoration-none text-info fw-bold" data-bs-toggle="tooltip" data-bs-placement="left" title="Contatos" href="<?= url("/contatos"); ?>">Contatos</a></li>
                    <?php if(!empty($user->id)):?>
                        <li class="mb-2"><a class="text-decoration-none text-info fw-bold" data-bs-toggle="tooltip" data-bs-placement="left" title="Painel" href="<?= url("/dashboard"); ?>">Painel</a></li>
                    <?php else: ?>
                        <li class="mb-2"><a class="text-decoration-none text-info fw-bold" data-bs-toggle="tooltip" data-bs-placement="left" title="Entrar" href="<?= url("/entrar"); ?>">Entrar</a></li>
                    <?php endif;?>
                </ul>
            </div>
