...
<header class="navbar navbar-expand-lg bd-navbar sticky-top">
    <nav class="container-xl bd-gutter flex-wrap flex-lg-nowrap" aria-label="Main navigation">
        <a class="navbar-brand p-0 me-0 me-lg-2 fw-bold" href="/" aria-label="Bootstrap">
            <i class="bi bi-book-half text-light display-6"></i>
        </a>
        ...
        <div class="offcanvas-lg offcanvas-end flex-grow-1" tabindex="-1" id="bdNavbar" aria-labelledby="bdNavbarOffcanvasLabel" data-bs-scroll="true">
            <div class="offcanvas-header px-4 pb-0">
                <h5 class="offcanvas-title text-light" id="bdNavbarOffcanvasLabel">SMSUB AGENDA</h5>
            ...
            <div class="offcanvas-body p-4 pt-0 p-lg-0">
                ...
                <ul class="navbar-nav flex-row flex-wrap bd-navbar-nav">
                    ...
                    <li class="nav-item col-6 col-lg-auto">
                        <a class="nav-link py-2 px-0 px-lg-2" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Sobre" href="<?=url("/sobre")?>" onclick="ga('send', 'event', 'Navbar', 'Community links', 'Sobre');">Sobre</a>
                    </li>
                    <li class="nav-item col-6 col-lg-auto">
                        <a class="nav-link py-2 px-0 px-lg-2" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Antiga" href="http://<?=CONF_DB_HOST?>/agendav1/" onclick="ga('send', 'event', 'Navbar', 'Community links', 'Antiga');">Antiga</a>
                    </li>
                    <li class="nav-item col-6 col-lg-auto">
                        <a class="nav-link py-2 px-0 px-lg-2" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Blog" href="<?=url("/blog")?>" onclick="ga('send', 'event', 'Navbar', 'Community links', 'Blog');">Blog</a>
                    </li>
                </ul>
                ...
                <ul class="navbar-nav flex-row flex-wrap ms-md-auto">
                    ...
                    <li class="nav-item dropdown">
                        <button type="button" class="btn btn-link nav-link py-2 px-0 px-lg-2 dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false" data-bs-display="static">
                            <span class="d-lg-none" aria-hidden="true">Agenda</span><span class="visually-hidden">Bootstrap&nbsp;</span> v2.1 <span class="visually-hidden">(switch to other versions)</span>
                        </button>
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><h6 class="dropdown-header">v2 lançamentos</h6></li>
                            <li>
                                <a class="dropdown-item d-flex align-items-center justify-content-between active" aria-current="true" href="/docs/5.3/getting-started/introduction/">
                                    Mais recente (2.1)
                            ...
                            <li><a class="dropdown-item" href="https://getbootstrap.com/docs/4.6/">v2.0</a></li>
                            <li><hr class="dropdown-divider"></li>
                            <li><a class="dropdown-item" href="/docs/versions/">Antiga</a></li>
                        </ul>
                    </li>
    ...
    <div class="container py-4 py-md-5 px-4 px-md-3 text-body-secondary">
        <div class="row">
            <div class="col-lg-3 mb-3">
                <a class="d-inline-flex align-items-center mb-2 text-body-emphasis text-decoration-none" href="<?=url("/contatos")?>" aria-label="Bootstrap">
                    <i class="bi bi-book fs-1 mb-3 me-2 text-info fw-bold"></i>
                    <span class="text-info fw-bold fs-6">SMSUB AGENDA</span>
                </a>
                <ul class="list-unstyled small">
                    <li class="mb-2">Desenvolvido com todo amor por Rodolfo R. R. de Jesus <a class="text-decoration-none text-info fw-bold" href="https://github.com/rrrjesus/"><i class="bi bi-github"></i>rrrjesus</a> e equipe <strong>SMSUB-COTI</strong>.</li>
                    <li class="mb-2">Código licenciado <a class="text-info fw-bold" href="https://github.com/rrrjesus/agenda/blob/main/LICENSE" target="_blank" rel="license noopener">MIT</a></li>
                    <li class="mb-2">Versão Atual v2.0.2.</li>
                    <li class="mb-2">Código Fonte <a class="text-info fw-bold" href="https://github.com/rrrjesus/agenda" target="_blank" rel="noopener"><i class="bi bi-github"></i> @rrrjesus/agenda</a>.</li>
                </ul>
            </div>
