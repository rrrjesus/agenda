        ...
        <div class="row">
            <div class="col-lg-3 mb-3">
                ...
                <ul class="list-unstyled small">
                    ...
                    <li class="mb-2">Código Fonte <a data-bs-togglee="tooltip" data-bs-placement="right" data-bs-custom-class="custom-tooltip" data-bs-title="GitHub do Desenvolvedor" class="text-decoration-none text-info fw-bold" href="https://github.com/rrrjesus" target="_blank" rel="noopener"><i class="bi bi-github"></i> @rrrjesus/agenda</a>.</li>
                </ul>
            </div>
