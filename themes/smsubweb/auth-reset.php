...
<article class="auth">
    <div class="auth_content container content">
        ...
        <form class="auth_form" action="<?=url("/recuperar/resetar")?>" method="post" enctype="multipart/form-data">
            ...
            <label>
                <div class="unlock-alt"><span class="icon-envelope">Repita Nova Senha</span></div>
                    <input type="password" name="password_re" placeholder="Nova senha" required/>
            </label>

            <button class="auth_form_btn transition gradient gradient-<?=CONF_SITE_BASECOLOR?> gradient-hover">Alterar Senha</button>
        </form>
    </div>
</article>