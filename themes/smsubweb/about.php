    ...
    <div class="row g-5 mt-1 me-0 ms-0">
        <div class="col-md-8">
            ...
            <article class="blog-post">
                ...
                <p class="mt-2">Surge então o projeto <strong>Agenda 2.0</strong> com a proposta de um filtro de contatos mais dinâmico, um layout mais limpo e intuitivo e ferramentas de
                    código aberto para facilitar o uso da agenda. A estrutura foi construída em <a class="text-decoration-none text-info fw-semibold" target="_blank"
                    href="https://www.php.net/manual/pt_BR/language.oop5.php">PHP POO</a> segundo as <a class="text-decoration-none text-info fw-medium"
                ...
                <p class="mt-2">Além disso o plugin <a class="text-decoration-none text-info fw-semibold" target="_blank" href="https://datatables.net/">Jquery Datatables</a>
                    trouxe a lista de contatos recursos poderosos da linguagem Javascript e sua biblioteca <a class="text-decoration-none text-info fw-semibold" target="_blank" href="https://pt.wikipedia.org/wiki/JQuery">
                ...
                <p class="mt-2" >Na <strong>Agenda 2.1</strong> o foco é no front-end responsivo, para isso o kit de ferramentas repleto de recursos <a class="text-decoration-none text-info fw-semibold"
                ...
                <hr>
                <p class="mt-2">O tema pode ser selecionado no modo <span class="badge text-bg-light">Claro</span>, <span class="badge text-bg-dark">Escuro</span> e auto, no menu superior com um clique, o sistema muda a <a class="text-decoration-none text-info fw-semibold" target="_blank"
        ...
        <div class="col-md-4">
            <div class="position-sticky" style="top: 4rem;">
                <div class="p-4 mb-3 text-bg-info text-light rounded">
