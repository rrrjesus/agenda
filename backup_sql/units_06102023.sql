...
--
-- Host: 127.0.0.1
-- Tempo de geração: 06/10/2023 às 23:03
...
(3, 'SUB - CL', 'CAMPO LIMPO', 'Rua Nossa Senhora do Bom Conselho, 59 - Chacara Nossa Sra. do Bom Conselho', '05763-470', 'logo_ass_campo_limpo', 'Darcio Luiz Americo Silva', '33970564', '', '94598-6415', 'darcioamerico@smsub.prefeitura.sp.gov.br', '2023-10-06 20:47:49', NULL),
...
(8, 'SUB - EM', 'ERMELINDO MATARAZZO', 'Av. São Miguel, 5550 - Parque Boturussu', '03871-100', 'logo_ass_ermelindo_matarazzo', 'Alecio Gasperine JR', '2026-9326', '', '97193-9941', 'agasperini@smsub.prefeitura.sp.gov.br', '2023-10-06 20:47:49', NULL),
(9, 'SUB - FO', 'FREGUESIA BRASILANCIA', 'Av. João Marcelino Branco, 95 - Vila dos Andrades', '02610-000', 'logo_ass_freguesia_brasilancia', 'Marcelo Bizerra', '', '', '99396-6068', 'marcelobizerra@smsub.prefeitura.sp.gov.br', '2023-10-06 20:47:49', NULL),
...
(15, 'SUB - JT', 'JAÇANÃ TREMEMBÉ', 'Av. Luis Stamatis, 300 - Vila Constança', '02260-000', 'logo_ass_jaçana_tremembé', 'Douglas Eduardo Caldeira de Oliveira', '3218-4700', '4772', '97094-9665', 'decoliveira@smsub.prefeitura.sp.gov.br', '2023-10-06 20:47:49', NULL),
